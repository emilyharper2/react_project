  ...
  return (
    <Layout>
      ...
      <View
        ...
        >
            <Text style={{fontWeight: 'bold', marginTop: 10, color: 'black', fontSize: 20}}> What are Scope 3 carbon emissions? </Text>
            <Text style={{textAlign: 'justify', marginHorizontal:20, color: 'black',  fontSize: 16, marginBottom: 10, marginTop:10}}>Stated by Environmental Protection Agency, Scope 3 emissions are “the result of activities from assets not owned or controlled by the reporting organization but that the organization indirectly impacts in its value chain”. This includes factors such as employee business travel, employee commuting, freighting goods for the company or even employee hotel stays in various countries.</Text>
...
<View style={{ 
          ...
          borderColor: 'steelblue',
            ...
            <Text style={{textAlign:'center', color: 'black', fontSize: 16, marginTop: 10}}> 4 x 20.9 = 83.6 kgCO2e
            </Text>
            <Text style={{textAlign: 'justify', marginHorizontal:20, marginBottom: 15, color: 'black', fontSize: 16, marginTop: 10}}>where 20.9 is the 2021 conversion factor for the Netherlands.</Text>
        </View>
      </ScrollView>
    </Layout>
  );
