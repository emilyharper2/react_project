  ...
  useEffect(() => {
    setTimeout(() => {
      setCountries ([
        ...
        {name: 'Small Motorbike', factor: 0.08306},
        {name: 'Medium Motorbike', factor: 0.1009},
        {name: 'Large Motorbike', factor: 0.13245},
        {name: 'Average Motorbike', factor: 0.11355},
...
<View style={{
  ...
  onPress={() => Alert.alert("Emissions Added")}/>
